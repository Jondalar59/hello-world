...
public class Sell extends JDialog {
    ...
    public Sell() {
        ...
        registroV.setBackground(Prinicipal.azulbajo);
        ...
        venderbtn.setBackground(Prinicipal.azulbajo);
        ...
        muertebtn.setBackground(Prinicipal.azulbajo);
