...
public class Ventanas {
    ...
    public static void main(String[] args) {
        ...
        JRadioButton macho = new JRadioButton("", true);
        macho.setBounds(30, 230, 20, 20);
        registro.add(macho);
        ...
        //Ventana Principal
        JFrame Principal = new JFrame(); // JFrame ventana principal donde se alojan 3 Botones
        Principal.setSize(new Dimension(700, 700));
        Principal.setResizable(false);
        Principal.setVisible(false);
        Principal.setLocationRelativeTo(null);// La ventana aparece en el centro de la pantalla
        ...
        JDialog Login = new JDialog(Principal, "Login", false); //JDialog para hacer el Login que permite la entrada
